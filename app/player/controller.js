      ...
      try {
         ...
         const payload = {
            ...
            historyPayment: {
               ...
               accountNo: res_bank._doc.accountNo,
            },
            name: name,
   ...
   dashboard: async (req, res) => {
      try {
         ...
         category.forEach((cat) => {
            count.forEach((cou) => {
               if (cou._id.toString() == cat._id.toString()) {
                  cou.name = cat.name;
               }
            });
         });
   ...
   editProfile: async (req, res) => {
      try {
         ...
         if (req.file) {
            ...
            let avatar = req.file.filename + "." + originalExt;
            ...
            src.on("end", async () => {
               ...
               let currentImage = `${config.rootPath}/public/upload/${oldPlayer.thumbnail}`;
